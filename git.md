...
# Практическое задание
    ...
    1. Отменить коммит,
    2. Пуш с игнорированием ошибок ,
    3. git branch вывести все ветки,
    4. Переместиться на ветку,
    5. Восстановить удаленный коммит,
    6. cherry-pick

# 1. Отменить коммит
#### [Перейти к git reset](#reset)

# 2. Пуш с игнорированием ошибок
  
    git push --force
Таким образом, можно принудительно перезаписать удаленную ветку, игнорируя любые ошибки, которые могут возникнуть.

# 3. git branch вывести все ветки
#### [Перейти к git branch](#branch)
# 4. Переместиться на ветку
    git checkout name_branch
# 5. Восстановить удаленный коммит

### Для начала сделаем изменения в локальном репозитории. Добавим изменения (git add .), закоммитим -> удалим с помощью git reset HEAD^

## Для восстановления выполним следующие действия:

### 1. git reflog

Команда git reflog выводит список всех действий, которые были выполнены в вашем репозитории, включая все коммиты, которые были удалены.
Необходимо найти хеш удаленного коммита в списке вывода git reflog.

![alt text](screenshots/reflog.png)

В моем случае, удаленный коммит второй в списке с хэшем 8599195, который добавлял некоторые изменения

### 2.  git reset

Команда git reset отменяет изменения в коммите и перемещает указатель HEAD на указанный коммит. 
Для восстановления удаленного коммита необходимы следующие действия:

![alt text](screenshots/reset-hard.png)

После выполнения этой команды Git переместит указатель HEAD на удаленный коммит и восстановит изменения в рабочей директории.

# 6. cherry-pick
#### [Перейти к cherry-pick](#cherry-pick)
